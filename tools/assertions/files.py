...
def assert_create_files_response(request: CreateFileRequestSchema, response: CreateFileResponseSchema):
    ...
    :param request: Исходный запрос на создание файла (экземпляр pydantic схемы)
...
def assert_get_file_with_incorrect_file_id_response(actual: ValidationErrorResponseSchema):
    """
    Проверяет, что ответ на попытку получения файла с неправильным ID соответствует ожидаемой валидационной ошибке.
